 ...
 *   https://datatables.net/download/#dt/dt-2.1.8/b-3.2.0/date-1.5.4/fh-4.0.1/sl-2.1.0
 *
 * Included libraries:
 *   DataTables 2.1.8, Buttons 3.2.0, DateTime 1.5.4, FixedHeader 4.0.1, Select 2.1.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.1.8/b-3.2.0/date-1.5.4/fh-4.0.1/sl-2.1.0",
